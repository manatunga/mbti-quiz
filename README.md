...
The aim of this side project is to mainly consolidate my JavaScript fundamentals, whilst diving into utilising Tailwind Css's utility classes to style the quiz's frontend.
